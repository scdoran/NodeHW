...
// The song title is index one when we split the data from the document and turn it into an array.
 ...
 // Spotify will pull up the first 5 matches for the song request.
